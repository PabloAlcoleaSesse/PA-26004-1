...
- [ ] Choose the application stack and design a shared music-library model.
...
No runtime or build setup has been selected yet. Setup instructions will be added with the first implementation.
